...
public class FixedHeader {
    ...
    private enum MessageType { CONNECT, CONNACK, PUBLISH, PUBACK, PUBREC, PUBREL, PUBCOMP, SUBSCRIBE, UNSUBSCRIBE,
                             UNSUBACK, PINGREQ, PINGRESP, DISCONNECT }

    private enum QoSLevel { AT_MOST_ONCE, AT_LEAST_ONCE, EXACTLY_ONCE }
     ...
     */
    public static void encodeRemainingLength(long length, ByteBuffer buffer) throws LimeBrokerException
    {
        checkLength(length);
        do
        {
     ...
     * @throws LimeBrokerException
     */
    public static long decodeRemainingLength(ByteBuffer buffer) throws LimeBrokerException
    {
        long multiplier = 1;
        long length = 0;
        byte digit;
