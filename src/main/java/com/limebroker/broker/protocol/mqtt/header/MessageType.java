...
public enum MessageType {
    CONNECT((byte) 1), CONNACK((byte) 2), PUBLISH((byte) 3), PUBACK((byte) 4), PUBREC(
            ...
            (byte) 9), UNSUBSCRIBE((byte) 10), UNSUBACK((byte) 11), PINGREQ(
            (byte) 12), PINGRESP((byte) 13), DISCONNECT((byte) 14);
    ...
    /**
     * Returns a MessageType based MessageType 4bit code. As specified in MQTT
     * Spec.
     * 
     * @param code
     * @return
    ...
    /**
     * Returns a MessageType based on the 4bit byte code as it is read from the
     * wire.
     * 
     * @param code
     * @return
